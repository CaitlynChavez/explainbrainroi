...
`explainbrainROI` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/explainbrainROI
[issue tracker]: https://github.com/<USERNAME>/explainbrainROI/issues
